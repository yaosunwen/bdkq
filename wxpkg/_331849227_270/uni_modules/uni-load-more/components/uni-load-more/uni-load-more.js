var e, n = require("../../../../common/vendor.js"), o = require("./i18n/index.js");

setTimeout(function() {
    e = n.index.getDeviceInfo().platform;
}, 16);

var t = n.initVueI18n(o.messages).t, i = {
    name: "UniLoadMore",
    emits: [ "clickLoadMore" ],
    props: {
        status: {
...
}, c = n._export_sfc(i, [ [ "render", function(e, o, t, i, c, A) {
    return n.e({
        ...
        o: n.t("more" === t.status ? A.contentdownText : "loading" === t.status ? A.contentrefreshText : A.contentnomoreText),
        p: t.color
    } : {}, {
        q: n.o(function() {
